...
@section('content')
    ...
    <div class="contenedor">
        ...
        <div class="row w-auto my-3">
            ...
            <div class="col small text-muted d-flex flex-wrap gap-2 align-items-center">
                <span class="fw-semibold">Acciones:</span>
                <span class="badge bg-info text-dark"><i class="bi bi-eye"></i> Ver</span>
                <span class="badge bg-warning text-dark"><i class="bi bi-clock-history"></i> Reagendar</span>
                <span class="badge bg-success"><i class="bi bi-calendar-check"></i> Marcar Atendida</span>
                <span class="badge bg-danger"><i class="bi bi-calendar-x"></i> Cancelar</span>
            </div>
        </div>
                ...
                @foreach ($citas as $cita)
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            @if($cita->status != 'Atendida')
                                <a href="/terminar-cita/{{$cita->id}}" class="btn btn-success btn-sm mb-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            @endif
                            @if($cita->status != 'Atendida')
                                <a href="/cancelar-cita/{{$cita->id}}" class="btn btn-danger btn-sm eliminar-cita mb-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
