            ...
            <form class="needs-validation" action="{{route('update', ['id' => $cita->id])}}" method="POST" novalidate>
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="cedula" maxlength="9" pattern="[0-9]+" value="{{$cita->personas->cedula}}" required>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" pattern="^[a-zA-ZÑñÁáÉéÍíÓóÚú\s]+$" value="{{$cita->personas->nombre}}" name="nombre" required>
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <input type="date" class="form-control" name="fecha_nacimiento" value="{{$cita->personas->fecha_nacimiento}}" rows="3" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col">
                        ...
                        <input type="text" pattern="[0-9]{11}" minlength="11" maxlength="11" value="{{$cita->personas->telefono}}" class="form-control" name="telefono" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col">
                        ...
                        <input type="text" pattern="[a-zA-ZÑñÁáÉéÍíÓóÚú0-9._\-]+@[a-zA-ZÑñÁáÉéÍíÓóÚú0-9.\-]+\.[a-zA-Z]{2,}$" class="form-control" value="{{$cita->personas->correo}}" name="correo" required>
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            @if ($cita->personas->sexo == 1) checked @endif value="1">
                            <label class="form-check-label" for="inlineRadio1">Masculino</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sexo" 
                            @if ($cita->personas->sexo == 0) checked @endif  value="0">
                ...
                <div class="mb-3 row">
                    <div class="col-lg-6">
                        ...
                        <select class="form-select mb-3" name="patria">
                            ...
                            <option value="{!!$asunto->id!!}" {{ $cita->id_patria == $asunto->id ? 'selected' : '' }}>{!!$asunto->opciones!!}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlTextarea1" class="form-label">Fecha de cita:</label>
                        <input type="date" class="form-control" value="{{$cita->fecha_cita}}" name="fecha_cita" rows="3" required>
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        ...
                        <textarea class="form-control" name="detalles" rows="5" required>{{$cita->detalles}}</textarea>
                        <div class="invalid-feedback">
