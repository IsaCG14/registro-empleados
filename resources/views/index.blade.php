        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-info ver-persona mb-1" id="{{ $atendido->id }}" data-bs-toggle="modal"
                    ...
                    <td>
                        <a href="/editar-persona/{{ $atendido->id }}" class="btn btn-sm btn-primary mb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <td>
                        <a href="/agendar-cita/{{ $atendido->id }}" class="btn btn-sm btn-warning mb-1"><svg
                    ...
                    <td>
                        @if (auth()->user()->rol)
                        <a href="/eliminar-persona/{{ $atendido->id }}" class="btn btn-sm btn-danger eliminar-persona mb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
