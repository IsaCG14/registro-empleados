...
<body>
    <nav class="navbar navbar-expand-lg bg-dark position-fixed w-100" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <div>
                <li class="nav-item dropdown me-5 list-unstyled">
                    <a class="nav-link dropdown-toggle text-white me-5" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
    ...
    <nav class="navbar navbar-expand-lg bg-dark position-fixed w-100" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="/img/icono.png" width="40" height="40" class="d-inline-block align-text-top">
            </a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup"
                aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            ...
            <li class="nav-item dropdown me-5 list-unstyled">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <form action="/logout" method="get">
                            <a href="#" class="dropdown-item text-white" onclick="this.closest('form').submit()">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z" />
    ...
    <footer>
        <div class="text-center p-3 bg-dark text-white mt-4">
            Corpocentro ® <span id="year"></span>. RIF: J-20008343-3. Copyleft. Desarollado por la Oficina de Tecnología
            de Información y
            Comunicación.
        </div>
    </footer>
