                ...
                <div class="mb-3 row">
                    <div class="mb-3 col-lg-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" maxlength="8" value="{{ old('cedula') }}"
                                pattern="[0-9]+" name="cedula" id="cedula" required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-lg-6">
                        ...
                        @foreach($asuntos as $asunto)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="{!!$asunto->id!!}"
                                    id="patria-{!!$asunto->id!!}" name="patria[]">
